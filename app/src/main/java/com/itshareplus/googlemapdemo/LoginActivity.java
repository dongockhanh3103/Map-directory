...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (firebaseAuth.getCurrentUser() != null) {
                    Intent nextScreen = new Intent(LoginActivity.this, Template_MainActivity.class);
    ...
    private void prepareGoogleAPI() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(LoginActivity.this
                        /* FragmentActivity */, new GoogleApiClient.OnConnectionFailedListener() {
                            @Override
    ...
    private void initControl() {
        ...
        mGoogleSignInButton = (Button) findViewById(R.id.googleSignIn);
