...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRecorder=(ImageView) findViewById(R.id.btnSpeak);

        btnRecorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {setRecorder();
            }
        });
    ...
    private  void setRecorder(){
        ...
        if(intent.resolveActivity(getPackageManager())!=null){
            ...
            Toast.makeText(this,"Your Devide Don't Support Speech Input",Toast.LENGTH_LONG);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng hcmus = new LatLng(10.851067, 106.772356);
