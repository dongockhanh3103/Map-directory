...
public class RegistrationActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mPasswordView, mUserView, mConfirmPassword;
    ...
    private void attempregister() {
        ...
        if (TextUtils.isEmpty(username)) {
            mUserView.setError("This field is required");
            focusView = mUserView;
            cancel = true;
        }
        ...
        if (!isComfirmPasswordValid(password, confirmpassword)) {
            mConfirmPassword.setError("This field is not match");
            focusView = mConfirmPassword;
            cancel = true;
        }
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                View focusview = null;
                                showProgress(false);
                                mEmailView.setError("This Email already existed");
                                focusview = mEmailView;
                                ...
                                //Add Field to Database realtime
                                mDatabase.child("User").child(email).setValue(new User(username, email, "1"));
                            }
    ...
    private boolean isComfirmPasswordValid(String pass, String confirm) {
